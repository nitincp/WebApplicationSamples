...
namespace WebApplication1.Controllers
{
    ...
    public class AccountController : ApiController
    {
        ...
        public readonly ApplicationUserManager<ApplicationUser, string> _userManager;
        public readonly ISecureDataFormat<AuthenticationTicket> _accessTokenFormat;

        public AccountController(ApplicationUserManager<ApplicationUser, string> userManager,
        ...
        {
            var signInStatus = await this._signInManager.PasswordSignInAsync(model.UserName, model.Password, true, false);
        ...
        {
            IUser<string> user = await _userManager.FindByIdAsync(User.Identity.GetUserId());
            ...
            var userLogins = await this._userManager.GetLoginsAsync(user.Id);

            foreach (var linkedAccount in userLogins)
            {
            ...
            var hasPassword = await this._userManager.HasPasswordAsync(user.Id);
